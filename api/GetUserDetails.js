...
export const getDriver = async (userId) => {
    ...
    var config = {
        method: 'get',
        url: `https://dev100329.service-now.com/api/x_619543_amblreq/get_amblreq_details/getUserDetails?userId=${userId}`,
        headers: {
    ...
    axios(config)
        .then(function (response) {
            ...
            getUserDetailsController(response)
        })
...
export const getUserDetailsController = (response) => {
